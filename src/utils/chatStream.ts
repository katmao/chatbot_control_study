...
const SYSTEM_PROMPT = [
  ...
  '- Use Markdown bold only occasionally to emphasize one collaborative phrase when it appears naturally in the response.',
  '- Rotate collaborative phrases such as: "**we**", "**let’s**", "**we’re leaning toward**", "**we can adjust this**", "**we both**", "**shared decision**", and "**we can find the best option**".',
