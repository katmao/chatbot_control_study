...
const LOW_CONTROL_SYSTEM_PROMPT = [
  ...
  '- If multiple approved phrases appear in one message, bold each approved phrase that appears.',
  '- If no approved phrase appears in the message, do not use bold at all.',
  '',
  'You MUST NOT:',
