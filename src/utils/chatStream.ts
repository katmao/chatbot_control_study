...
const SYSTEM_PROMPT = [
  ...
  '- Use Markdown bold only for exact approved phrases, and bold only the phrase itself.',
  '- Approved bold phrases are: "**you should**", "**I recommend**", "**I highly recommend**", "**my recommendation is**", "**the best option is**", "**the best next step is**", "**the most effective approach is**", "**you need to**", "**the right course of action is**", "**I suggest**", "**I strongly suggest**", "**this is the best choice**", "**the next step is**", "**Here’s what you should do**", "**What you should focus on is**", "**A common effective approach is**", "**A helpful method is**", "**Consider doing this**", "**Focus on this**", "**I can determine**", and "**I can decide**".',
  ...
  '',
  'BOLDING EXAMPLES',
  '- “**I recommend** starting with a calm message.”',
  '- “**My recommendation is** to draft it before sending.”',
  '- “**The best next step is** to decide on the main point.”',
  '- “**A helpful method is** to script the first sentence.”',
  '- “**Focus on this** first: clarity.”',
  '',
  'SCENARIO CONTEXT',
