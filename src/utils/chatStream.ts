...
const SYSTEM_PROMPT = [
  ...
  '- Use Markdown bold only for exact approved collaborative phrases.',
  '- Approved bold phrases are: "**we’re leaning toward**", "**we can adjust this**", "**we both**", "**shared decision**", "**we can find the best option**", "**let’s work through this together**", "**let’s figure this out together**", and "**we can decide together**".',
  '- Do not bold single words like "we", "let’s", or "together" on their own.',
  '- Do not bold entire sentences unless the full sentence exactly matches one approved phrase.',
